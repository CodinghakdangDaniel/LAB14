...
/* changeRandomQuote section */
function changeRandomQ() {
    var randomQuote = quotes[Math.floor(Math.random() * quotes.length)];

        if (Object.keys(randomQuote).length === 2) {
            newQuote.innerHTML = randomQuote.quote + '<br>' + '<br>' + randomQuote.source + '<br>' + '<br>';
        }
        else if (Object.keys(randomQuote).length === 3) {
            newQuote.innerHTML = randomQuote.quote + '<br>' + '<br>' + randomQuote.source + '<br>' + '<br>' + randomQuote.citation;
        }
        else if (Object.keys(randomQuote).length === 4) {
            newQuote.innerHTML = randomQuote.quote + '<br>' + '<br>' + randomQuote.source + '<br>' + '<br>' + randomQuote.citation + '<br>' + '<br>' + randomQuote.year;
        }
    ...
    backGroundColor.style.backgroundColor = rgb;

};


/* change backgroundColor and Quote every 3 secnods automatically */
function changeAuto(){
...
// var rgb = [r, g, b];
// console.log(rgb);
// console.log(Object.keys(randomQuote));

// function changeRandomQuote(a, b, c, d) {
//         if (Object.keys(randomQuote).length === 2) {
//             newQuote.innerHTML = a + '<br>' + '<br>' + b + '<br>' + '<br>';
//         }
//         else if (Object.keys(randomQuote).length === 3) {
//             newQuote.innerHTML = a + '<br>' + '<br>' + b + '<br>' + '<br>' + c;
//         }
//         else if (Object.keys(randomQuote).length === 4) {
//             newQuote.innerHTML = a + '<br>' + '<br>' + b + '<br>' + '<br>' + c + '<br>' + '<br>' + d;
//         };
        
        // backGroundColor.style.backgroundColor = colors[r, g, b];
    // }  

// changeRandomQuote (randomQuote.quote, randomQuote.source, randomQuote.citation, randomQuote.year);